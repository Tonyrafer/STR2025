...
// Task2: Imprime el estado de Task1 cada 1 segundo
void monitor_task(void *pvParameters)
{
    TaskHandle_t task_handler = (TaskHandle_t)pvParameters;
    while (1)
    {
...
void app_main()
{
    ...
    xTaskCreate(monitor_task,"Task2",2048,(void *)task_handler,1,NULL);
